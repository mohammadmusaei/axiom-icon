import { AxiomIconLinejoin, AxiomIconLinecap } from './axiom-icon/axiom-icon.component';
import { AxiomIconConfig } from './axiom-icon/axiom-icon-config';
...
export class AppComponent {
  ...
  constructor(private _config : AxiomIconConfig,private _changeDetector : ChangeDetectorRef){
